...
{
    /// <inheritdoc />
    public partial class AddChatAndManagerStyleProfile : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ManagerStyleProfiles",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Tone = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    PreferBullets = table.Column<bool>(type: "boolean", nullable: false),
                    IncludeRisksByDefault = table.Column<bool>(type: "boolean", nullable: false),
                    AutoCreateTasks = table.Column<bool>(type: "boolean", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManagerStyleProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ManagerStyleProfiles_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sources = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPrompt = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
                    AIResponse = table.Column<string>(type: "character varying(8000)", maxLength: 8000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIInteractionLogs_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AIInteractionLogs_Tasks_TaskItemId",
                        column: x => x.TaskItemId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AIInteractionLogs_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIInteractionLogs_ProjectId",
                table: "AIInteractionLogs",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_AIInteractionLogs_TaskItemId",
                table: "AIInteractionLogs",
                column: "TaskItemId");

            migrationBuilder.CreateIndex(
                name: "IX_AIInteractionLogs_TenantId",
                table: "AIInteractionLogs",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManagerStyleProfiles_UserId",
                table: "ManagerStyleProfiles",
                column: "UserId",
                unique: true);
